package {
	...
	public var XRegExp:* = (function():* {
		...
		function runTokens(pattern:String, pos:int, scope:int, context:Object):Object {
			var i:int = tokens.length, result:* = null, match:*, t:*;
		 ...
		 * }
		 */
		self.cache = function (pattern:*, flags:String):* {
